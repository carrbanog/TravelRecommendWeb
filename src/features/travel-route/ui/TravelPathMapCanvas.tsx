...
export const TravelPathMapCanvas = React.memo(({ activeTab, roadPath, colors, hoveredPlace, onPlaceHover, onPlaceLeave }: Props) => {
    ...
    <MyMap place={center} zoom={13}>
      {selectedPlaces.map((place) => (
        <Marker
          ...
          title={place.title}
          onMouseOver={() => onPlaceHover(place.placeId)}
